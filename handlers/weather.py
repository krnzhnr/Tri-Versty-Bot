...
""")
            ...
            d >= 0:
            d = ("""
Если невнимательно подойти к выбору одежды в такую погоду, удовольствия может хватить буквально на пару минут, а после этого неминуемо захочется домой к маме.
...
При этом ни в коем случае не вздумайте надевать пуховик или что-то в этом роде. Куртка должна «дышать», но не промокать. Возможно, ближе к 0°С, вы захотите надеть легкую флиску. Под куртку.
...
Кстати, где-то в такую погоду уже можно задуматься о легкой «балаклаве», которая кроме ушей и верхней части головы, подставленной под ветер, защищает шею.
...
Термофляга и гидратор под одеждой. При отрицательных температурах вода во фляге может замерзнуть неожиданно быстро. Не говоря уже о том, что через 15-20 минут езды она станет слишком холодной, чтобы её можно было комфортно пить. Задумайтесь об этом до выезда!
""")
        else:
            d = ("""
